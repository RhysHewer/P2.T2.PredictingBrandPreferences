...
Overall, however, the datasets are sufficiently similar. I will take the strategy of splitting into training, test and validation sets. 
The training and testing sets will come from the complete responses data. Validation from the incomplete responses.
